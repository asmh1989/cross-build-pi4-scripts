...
QT.global_private.enabled_features = reduce_exports neon posix_fallocate alloca_h alloca system-zlib dbus dbus-linked gui network printsupport sql testlib widgets xml libudev openssl dlopen relocatable largefile precompile_header enable_new_dtags neon
